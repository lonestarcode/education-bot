...
/**
 * Represents content for the Science subject.
 */
@Entity
@Table(name = "science_content")
public class Science {
    ...
    public Science(String title, String contentBody, String fieldOfStudy, String proficiencyLevel) {
        this.title = title;
    ...
    public void setFieldOfStudy(String fieldOfStudy) {
        if (fieldOfStudy == null || fieldOfStudy.trim().isEmpty()) {
            throw new IllegalArgumentException("Field of study cannot be blank");
        }
        this.fieldOfStudy = fieldOfStudy;
    }
